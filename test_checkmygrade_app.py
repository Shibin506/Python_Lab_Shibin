...
class TestCheckMyGradeApp(unittest.TestCase):
    ...
    def test_student_addition(self):
        student = Student("shibin", "biji", "shibinbiji@sjsu.edu", "DATA200", "A", "95")
        self.student_list.add_new_student(student)
        self.assertIsNotNone(self.student_list.search_student("shibinbiji@sjsu.edu"))
    ...
    def test_sorting_by_name(self):
        students = [
            Student("shibin", "biji", "shibinbiji@sjsu.edu", "DATA200", "A", "95"),
